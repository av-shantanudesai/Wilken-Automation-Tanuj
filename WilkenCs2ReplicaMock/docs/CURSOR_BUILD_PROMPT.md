...
`Home → Prozesse verwalten (ALDI flow) → report screen → confirmation → Fortschritt → Liste anzeigen base → Druckauswahl → spool grid → right-click Export/Erweitert → Gitterbox initial XLS → Gitterbox XLSX → file export`
